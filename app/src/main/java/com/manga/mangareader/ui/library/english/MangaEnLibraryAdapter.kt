...
class MangaEnLibraryAdapter(private  val mangaList:List<Manga>, private val listener: MangaEnLibraryListener): RecyclerView.Adapter<MangaEnLibraryAdapter.MyViewHolder>() {
